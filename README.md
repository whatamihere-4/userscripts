...
Adds a **Download preview GIF** button on [SexLikeReal](https://www.sexlikereal.com/) scene pages. Fetches the 300p preview MP4 from the CDN, converts it to a 60 fps GIF, and saves `{sceneId}-preview.gif`. Output is capped at 15 MB (scaled to ~225×135 if needed).
